...
from global_config.global_config import CROSS_VALIDATION_WHEN_TARGETS_PATH, CROSS_VALIDATION_WHEN_PREDICTIONS_PATH

sns.set_style("whitegrid")

GROUND_TRUTH_PATH = CROSS_VALIDATION_WHEN_TARGETS_PATH
PREDICTED_PATH = CROSS_VALIDATION_WHEN_PREDICTIONS_PATH
NUM_FOLDS = 5
APPROXIMATE = True
...
ax.get_legend().remove()
sns.despine()
plt.savefig("./figures/roc_when_zoomed.png")
