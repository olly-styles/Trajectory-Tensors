...
from experiments.models import CNN_1D_Trajectory_Tensor_Classifier, CNN_2D_1D_Encoder
...
for multi_view_tensors in [True, False]:
    ...
    if multi_view_tensors:
        MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHEN, "2d1dcnn")
        PREDICTION_SAVE_PATH = os.path.join(CROSS_VALIDATION_WHEN_PREDICTIONS_PATH, "trajectory_tensors", "2d1dcnn")
    else:
        MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHEN, "2d1dcnn_single_view")
