...
for multi_view_tensors in [False]:
    ...
    if multi_view_tensors:
        MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHEN, "cnn_gru")
        PREDICTION_SAVE_PATH = os.path.join(CROSS_VALIDATION_WHEN_PREDICTIONS_PATH, "trajectory_tensors", "cnn_gru")
    else:
        MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHEN, "cnn_gru_single_view")
