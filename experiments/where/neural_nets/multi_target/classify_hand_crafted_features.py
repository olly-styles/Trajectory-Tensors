...
INPUT_SIZE = 10
OUTPUT_SIZE = NUM_CAMERAS * FUTURE_TRAJECTORY_LENGTH * BASE_HEATMAP_SIZE[0] * BASE_HEATMAP_SIZE[1]
LEARNING_RATE = 1e-3
BATCH_SIZE = 1
NUM_WORKERS = 4
WEIGHT_DECAY = 0
NUM_EPOCHS = 30
DEBUG_MODE = False
MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHERE, "hand_crafted_features")
...
MODEL_LOAD_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHERE, "hand_crafted_features")
...
for fold in range(1, NUM_CROSS_VAL_FOLDS + 1):
    ...
    test_args = {
        ...
        "debug_mode": False,
        "fold_num": fold,
        "predictions_save_path": CROSS_VALIDATION_WHERE_HAND_CRAFTED_FEATURE_PATH,
