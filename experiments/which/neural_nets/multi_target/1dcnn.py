...
from experiments.models import FullyConnectedClassifier, ConvolutionalEncoder
...
NUM_EPOCHS = 30
DEBUG_MODE = False
MODEL_SAVE_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHICH, "1dcnn")
...
MODEL_LOAD_PATH = os.path.join(CROSS_VALIDATION_MODELS_PATH_WHICH, "1dcnn")
